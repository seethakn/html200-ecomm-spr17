...
## Testing
  - From the design perspective (HTML & CSS) - Website layout was tested on different media such as mobile and laptop browsers by altering screen sizes & screen modes (landscape & portrait) to ensure website's responsive design.
  - From the functionality perspective (JS) - Project requirements to display cart total on addition and removal of product items was verified both on console & on display cart.
